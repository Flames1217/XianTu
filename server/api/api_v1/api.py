...
from .endpoints import worlds, characters, rules, auth, redemption, admin, talents, spirit_roots, origins, ai, talent_tiers, users, ban_management, system, workshop, presence, travel, world_instances, invasion, prompts

api_router = APIRouter()
api_router.include_router(world_instances.router, prefix="/worlds/instance", tags=["online-worlds"])
...
api_router.include_router(invasion.router, prefix="/invasion", tags=["invasion"])
